...
public class CategoryCIQ extends AbstractBsCategoryCQ {
    ...
    public String keepCategoryId_ExistsReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepCategoryId_NotExistsReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepCategoryId_SpecifyDerivedReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepCategoryId_QueryDerivedReferrer_StatementList(StatementCQ sq)
