...
public class AccountCIQ extends AbstractBsAccountCQ {
    ...
    public String keepAccountId_ExistsReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepAccountId_NotExistsReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepAccountId_SpecifyDerivedReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepAccountId_QueryDerivedReferrer_StatementList(StatementCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepAccountId_QueryDerivedReferrer_StatementListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
