...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.MemberLoginBhv"; }
