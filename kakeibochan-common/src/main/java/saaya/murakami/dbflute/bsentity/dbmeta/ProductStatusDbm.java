...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.ProductStatusBhv"; }
