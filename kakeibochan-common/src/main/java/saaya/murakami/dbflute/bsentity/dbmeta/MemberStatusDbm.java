...
public class MemberStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.MemberStatus"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.MemberStatusCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.MemberStatusBhv"; }
