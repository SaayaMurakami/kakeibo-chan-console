...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.ProductCategory"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.ProductCategoryCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.ProductCategoryBhv"; }
