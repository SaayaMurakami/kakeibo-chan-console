...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.MemberServiceBhv"; }
