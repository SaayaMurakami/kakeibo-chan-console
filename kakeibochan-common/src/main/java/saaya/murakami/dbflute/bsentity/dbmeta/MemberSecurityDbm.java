...
public class MemberSecurityDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.MemberSecurity"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.MemberSecurityCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.MemberSecurityBhv"; }
