...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.PurchasePaymentBhv"; }
