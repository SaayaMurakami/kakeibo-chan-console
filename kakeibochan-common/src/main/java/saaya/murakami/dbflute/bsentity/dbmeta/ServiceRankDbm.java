...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.ServiceRankBhv"; }
