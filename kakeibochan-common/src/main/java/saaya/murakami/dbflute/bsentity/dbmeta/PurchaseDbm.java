...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.PurchaseBhv"; }
