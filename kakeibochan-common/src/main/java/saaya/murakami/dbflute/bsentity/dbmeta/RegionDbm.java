...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "saaya.murakami.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "saaya.murakami.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "saaya.murakami.dbflute.exbhv.RegionBhv"; }
