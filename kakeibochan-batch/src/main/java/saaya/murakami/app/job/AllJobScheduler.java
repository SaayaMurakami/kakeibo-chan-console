...
import saaya.murakami.app.logic.context.AccessContextLogic;
...
public class AllJobScheduler implements LaJobScheduler {
    ...
    public void schedule(LaCron cron) {
        cron.registerNonCron(KakeiboJob.class, quitIfConcurrent(), op -> op.uniqueBy(KakeiboJob.class.getSimpleName()));
    }
